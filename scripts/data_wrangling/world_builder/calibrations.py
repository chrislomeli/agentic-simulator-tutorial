...
All calibration data lives in data/calibrations/*.json. This module
provides the schema, the logic that uses the data, and a registry.
...
Adding a calibration (e.g. Rocky Mountain ecology):
  1. Create data/calibrations/rocky-mountain.json following the same schema.
...
_CALIBRATION_DATA_DIR = Path(__file__).parent / "data" / "calibrations"

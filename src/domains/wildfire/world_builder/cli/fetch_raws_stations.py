...
Writes a JSON snapshot to:
    world_builder/raw/snapshots/raws_{region}.json

This is build-time tooling. The runtime simulator never calls this script —
it consumes the curated station list in world_builder/raw/regions/*.json.
...
_SNAPSHOT_DIR = Path(__file__).parent.parent / "raw" / "snapshots"
